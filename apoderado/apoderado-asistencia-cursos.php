									...
									while ($data = mysqli_fetch_array($queryCliente)) { ?>
										<tr>
											...
											<td>
												...
												<a
													href="../apoderado/apoderado-cursos-asistencia-alumno.php?usuario=<?php $usuario = $_SESSION['usuario']; echo $usuario ?>&alumno=<?php echo $data['alumno'] ?>&docente=<?php echo $data['docente'] ?>&nivel=<?php echo $data['nivel'] ?>&tema=<?php echo $data['tema'] ?>&grado=<?php echo $data['grado'] ?>">
