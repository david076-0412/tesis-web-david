                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-lg-3 order-3 order-md-2">
                            ...
                            <div class="xp-searchbar">
                                ...
                                <form method="post" action="apoderado-alumno-asistencia.php?usuario=<?php $usuario = $_SESSION['usuario'];
                                                                                                    echo "$usuario"; ?>">
                                        ...
                                        <tbody>
                                            <?php while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="../apoderado/apoderado-asistencia-cursos.php?usuario=<?php $usuario = $_SESSION['usuario']; echo $usuario ?>&alumno=<?php echo $data['alumno'] ?>">
