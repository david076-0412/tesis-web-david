            ...
            <div class="top-navbar">
                <div class="xd-topbar">
                    ...
                    <div class="xp-breadcrumbbar text-center">
                        <h4 class="page-title">Alumnos - Tutoria</h4>
                                    ...
                                    while ($data = mysqli_fetch_array($queryCliente)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../apoderado/apoderado-tutoria.php?usuario=<?php echo $data['usuario_apoderado'] ?>&nivel=<?php echo $data['nivel']; ?>&grado=<?php echo $data['grado']; ?>&usuario_alumno=<?php echo $data['usuario']; ?>&curso=Tutoria">
