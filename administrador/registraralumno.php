...
if ($cant_desc_estee == 0) {
    ...
    if ($estado_alumno == "Antiguo") {
        ...
        $query = "INSERT INTO alumno (usuario_apoderado, usuario_dni_apoderado, usuario_nombre_apoderado, 
        tipo_documento, dni, alumno, fecha_nacimiento, usuario, correo, 
        password, sexo, rol, foto_do_identidad, estado_alumno,foto_libreta, 
        discapacidad, tipo_discapacidad, nivel, grado, turno, horario, 
        codalu, ano_inscrip, modalidad, cant_desc_est, estado, tiempo_espera, 
