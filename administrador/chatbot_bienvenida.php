        ...
        <div id="sidebar">
            ...
            <ul class="list-unstyled component m-0">
                ...
                <li class="active">
                    ...
                    <a href="../administrador/chatbot_bienvenida.php?usuario=<?php $usuario = $_SESSION['usuario'];
                                    ...
                                    <?php while ($data = mysqli_fetch_array($queryClienteff)) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../administrador/eliminarbienvenida.php?id=<?php echo $data['id']; ?>&usuario=<?php $usuario = $_SESSION['usuario'];
                                                                                                                                    echo $usuario; ?>">
