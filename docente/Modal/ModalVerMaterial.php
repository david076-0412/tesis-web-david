            ...
            <form method="POST" action="">
                ...
                <div class="modal-body" id="cont_modal">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                            <a href="../docente/mostrar_material.php?nombre=<?php echo $data['nombre']; ?>&docente=<?php echo $data['docente']; ?>&tema=<?php echo $data['tema']; ?>&nivel=<?php echo $data['nivel']; ?>&grado=<?php echo $data['grado']; ?>" target="_blank">
