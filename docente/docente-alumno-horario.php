        ...
        <div id="sidebar">
            ...
            <ul class="list-unstyled component m-0">
                ...
                <li class="dropdown">
					...
					$usuario = $_SESSION['usuario']; echo "$usuario"; ?>&docente=<?php echo $data['apellido_paterno'] ?> <?php echo $data['apellido_materno'] ?> <?php echo $data['nombres'] ?>" class="dashboard"><i class="material-icons">account_balance_wallet</i>
						Asistencia</a>
